...
{
#if (USEFLOAT)
	typedef MANIPCORE_API Eigen::Vector3f Vector3;
	typedef MANIPCORE_API Eigen::Vector2f Vector2;
	typedef MANIPCORE_API Eigen::VectorXf VectorX;
	typedef MANIPCORE_API Eigen::Matrix4f Matrix4;
	typedef MANIPCORE_API Eigen::Matrix3f Matrix3;
#else
	typedef MANIPCORE_API Eigen::Vector3d Vector3;
	typedef MANIPCORE_API Eigen::Vector2d Vector2;
	typedef MANIPCORE_API Eigen::VectorXd VectorX;
	typedef MANIPCORE_API Eigen::Matrix4d Matrix4;
	typedef MANIPCORE_API Eigen::Matrix3d Matrix3;
#endif
